...
const docTemplateadmin = `{
    ...
    "paths": {
        ...
        "/api/v1/data_hub/marketplace/campaign": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/data_hub/marketplace/campaign/validation": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.MarketplaceValidationUpdateReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/data_hub/marketplace/campaign/validation/download": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/api/v1/data_hub/marketplace/campaign/validation/summary": {
            "get": {
                "security": [
                    {
                        "Bearer": []
